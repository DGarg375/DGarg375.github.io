...
const ProjectSliderMobile = (props) => {
    ...
    useEffect(() => {
        if(!toggleDescription) {
            ...
            document.getElementById("stack-container-id").style.display = "block";
        } else {
            document.getElementById("description-hide-id").style.display = "flex";
            document.getElementById("stack-container-id").style.display = "none";
        }
    ...
    return(
        <div class="slider-base-mobile">
            ...
            <div class="img-base">
                <img id="project-mobile-images" src={currentProject.imgSrc}></img>
